...
1.  In the **Storage** section, select your volume type from the **Volume Type** list. 
    ...
    - For AWS, BigAnimal currently supports General Purpose SSD (GP3) and io2 (or io2 Block Express for applicable instance types such as R5b). In **Volume Properties**, select the disk size for your cluster and configure the IOPS. 
